...
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/am_films'))

# Command
COMMAND_HAND_LER = environ.get("COMMAND_HAND_LER", "/")
PREFIX = environ.get("PREFIX", "/")

CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002157616054"))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002039807510') # support group id ( make sure bot is admin )
...
AI_LOGS = int(environ.get("AI_LOGS", "-1001583883335")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1001583883335'))

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/am_films') # How to open tutorial link for verification
...
BOT_USERNAME = environ.get("BOT_USERNAME", "lizav01_bot")
BOT_NAME = environ.get("BOT_NAME", "𝗭𝗜𝗔")
BOT_ID = environ.get("BOT_ID", "5867242467")
S_GROUP = environ.get('S_GROUP', "")
S_CHANNEL = environ.get('S_CHANNEL', "AM_UPLOAD")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+O4duIFR89SI1ZWY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/am_films')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/am_films') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ᴀᴍ_ꜰɪʟᴍꜱ')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/AM_UPLOAD') #Support group link ( make sure bot is admin )
